...
export class Contract {
    ...
    this.circuits = {
      is_claimed: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(f_0),
        ...
        const result_0 = this._is_claimed_0(context, partialProofData, f_0);
        partialProofData.output = { value: _descriptor_2.toValue(result_0), alignment: _descriptor_2.alignment() };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = { is_claimed: this.circuits.is_claimed };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _is_claimed_0(context, partialProofData, f_0) {
    const h_0 = this._persistentHash_0(f_0);
    return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                     ...
                                                                     [
                                                                      ...
                                                                      { push: { storage: false,
                                                                                value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(h_0),
